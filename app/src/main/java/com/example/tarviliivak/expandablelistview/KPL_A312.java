...
public class KPL_A312 extends AppCompatActivity {

    //this is the JSON Data URL
    //make sure you are using the correct ip else it will not work
    private static final String URL_PRODUCTS = "http://khktunniplaan.ikt.khk.ee/TUNNIPLAAN/Ruumid/KPL_A312.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            InfoAdapter adapter = new InfoAdapter(KPL_A312.this, productList);
