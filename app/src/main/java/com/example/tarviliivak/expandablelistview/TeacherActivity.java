    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.nav_student:
                Intent intent1 = new Intent(TeacherActivity.this, StudentActivity.class);
                startActivity(intent1);
                break;
            case R.id.nav_groups:
                Intent intent2 = new Intent(TeacherActivity.this, GroupActivity.class);
