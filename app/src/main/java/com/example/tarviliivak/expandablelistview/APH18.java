...
public class APH18 extends AppCompatActivity {

    //this is the JSON Data URL
    //make sure you are using the correct ip else it will not work
    private static final String URL_Info = "http://khktunniplaan.ikt.khk.ee/TUNNIPLAAN/Grupid/APH18.php";
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            InfoAdapter adapter = new InfoAdapter(APH18.this, infoList);
