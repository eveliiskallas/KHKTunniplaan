...
public class Auto extends AppCompatActivity {
    ...
    String items[] = new String [] {"AM17","AM18","AM19","APH118","APH18","APH19","APH218","APL17","APL18","APL19","AT117","AT118","AT119","AT217","AT218","AT219","AT318","AUD19","AUM18","AUM19","AUT17","AUT18"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position==4){
                    Intent myIntent = new Intent(view.getContext(), APH18.class);
