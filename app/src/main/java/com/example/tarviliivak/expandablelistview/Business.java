...
public class Business extends AppCompatActivity {
    ...
    String items[] = new String [] {"AK17","AK18","AK19","Akt17","Akt19","ARHt18","ARHt19","BT17","BT18","BT19","EKo19","EKt18","LM17","LM18","LM19","LOGo18","MK17","MKo18","MKt19","MKt217","MY17","MY18","MY19","MYEo18","MYEo19","RMo18","RMo19","RMt19","SRo18","SRo19"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if(position==0){
                    Intent myIntent = new Intent(view.getContext(), AK17.class);
                ...
                if(position==3){
                    Intent myIntent = new Intent(view.getContext(), Akt17.class);
